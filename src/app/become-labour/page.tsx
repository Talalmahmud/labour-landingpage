import { BecomeLabourForm } from "@/components/become-labour/become-labour-form";
...
export default async function BecomeLabourPage() {
        ...
        <section className="bg-linear-to-b from-slate-50 to-white px-6 py-16 text-center dark:from-background dark:to-background">
          <div className="mx-auto max-w-2xl">
            <h1 className="font-heading text-3xl font-extrabold text-blue-950 sm:text-4xl dark:text-white">
              {content.becomeLabourPage.heading}
            </h1>
            <p className="mt-3 text-base text-muted-foreground">
              {content.becomeLabourPage.subheading}
            </p>
          </div>
        </section>
        <BecomeLabourForm content={content.becomeLabourPage} services={content.services.items} />
      </main>

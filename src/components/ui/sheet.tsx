...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-0 bg-background shadow-lg ring-1 ring-foreground/10 outline-none duration-200 data-open:animate-in data-closed:animate-out",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 h-auto max-h-[85vh] border-b border-border data-open:slide-in-from-top data-closed:slide-out-to-top",
        bottom:
        ...
        left: "inset-y-0 left-0 h-full w-3/4 max-w-xs border-r border-border data-open:slide-in-from-left data-closed:slide-out-to-left",
        right:

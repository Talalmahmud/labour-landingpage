  ...
  return (
    <section className="mx-auto grid max-w-5xl grid-cols-1 gap-10 px-6 py-16 lg:grid-cols-5 ">
        ...
        {content.branches.map((branch) => (
          ...
          >
            <div className="flex items-center gap-2">
              <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-400">
                <Building2 className="size-4" />
              </span>
              <p className="font-heading text-sm font-bold text-blue-950 dark:text-white">
                {branch.name}
              </p>
            </div>
            <div className="flex flex-col gap-3">
              ...
              {branch.email && (
                <ContactDetail icon={Mail} label="Email" value={branch.email} />
              )}
              {branch.hours && (
                <ContactDetail
                  icon={Clock}
      ...
      <form
        ...
        className="flex self-start flex-col gap-4 rounded-2xl border border-border p-6 lg:col-span-3"
      >

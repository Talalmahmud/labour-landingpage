    ...
    <section id="services" className="mx-auto max-w-7xl px-6 py-16">
      ...
      <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
        {content.items.map((service) => {
          ...
          const card = (
            <div
              className="group flex h-full flex-col items-center gap-3 rounded-xl border border-border bg-background p-5 text-center shadow-xs transition-all hover:-translate-y-0.5 hover:shadow-md"
            >
